...
$\Delta x^k$ löst $\min \frac 12 \| F + J \Delta x\|_2^2 = \frac 12 F^T f + F^T J \Delta x + \frac 12 \Delta x^T J J^T \Delta x$ bzw. $J^T J \Delta x + J^T f = 0$, siehe auch (4.6). $\RA \Delta x^k = -(J^T J)^{-1} J^T F = -Mg$ mit $M = (J^T J)^{-1} = B^{-1}$
